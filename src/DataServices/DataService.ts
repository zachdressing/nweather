export const weatherCall = async (latitude:number, longitude:number, apiKey: string) => {
...
export const foreCall = async (latitude:number, longitude:number, apiKey: string) => {
...
export const localCall = async (searchVal:string, apiKey:string) =>{
...
export const reverseCall = async (latitude:number, longitude:number, apiKey: string) =>{
